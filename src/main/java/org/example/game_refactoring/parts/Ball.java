package org.example.game_refactoring.parts;
...
public class Ball implements Sprite {
     ...
     */
    public Ball(Point center, int radius, Color color) throws Exception {
     ...
     * @throws Exception if radius is not good
     */
    public Ball(double x, double y, int radius1, Color color) throws Exception {
        if (radius1 <= 0) {
